...
bool Texture::Init(ID3D12Device* pDevice, DiscriptorPool* pPool, const wchar_t* filename, DirectX::ResourceUploadBatch& uploadBatch)
{
	// 引数チェック
...
bool Texture::Init(ID3D12Device* pDevice, DiscriptorPool* pPool, const D3D12_RESOURCE_DESC* pDesc, bool isCube)
{
