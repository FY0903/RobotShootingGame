...
constexpr auto TU_BASE_COLOR = Material::TEXTURE_USAGE_COLOR;	// ベースカラー
constexpr auto TU_METALLIC = Material::TEXTURE_USAGE_METALLIC;	// メタリック
constexpr auto TU_ROUGHNESS = Material::TEXTURE_USAGE_ROUGHNESS;	// ラフネス
