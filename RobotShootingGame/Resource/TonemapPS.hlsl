...
{
    float3 result;
    result.r = (color.r <= 0.018f) ? 4.5f * color.r : (1.0f + 0.099f) * pow(abs(color.r), 0.45f) - 0.099f;
    result.g = (color.g <= 0.018f) ? 4.5f * color.g : (1.0f + 0.099f) * pow(abs(color.g), 0.45f) - 0.099f;
    result.b = (color.b <= 0.018f) ? 4.5f * color.b : (1.0f + 0.099f) * pow(abs(color.b), 0.45f) - 0.099f;
